...
# from constrained_birkhoff_von_neumann.bvn import constrained_birkhoff_von_neumann_decomposition
...
# constraint_structure = {frozenset({}): ()}
...
# ws, As, w_sum, reconstructed_X = constrained_birkhoff_von_neumann_decomposition(X, constraint_structure)
# print(ws)
# print(As)
# print(w_sum)
